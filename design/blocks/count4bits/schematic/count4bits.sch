...
C {lab_pin.sym} -350 60 2 0 {name=p4 sig_type=std_logic lab=0b}
...
C {iopin.sym} -350 -150 0 0 {name=p35 lab=vdd}
C {iopin.sym} -350 -130 0 0 {name=p36 lab=clk}
C {iopin.sym} -350 -70 0 0 {name=p38 lab=rst}
C {lab_pin.sym} -350 -110 2 0 {name=p3 sig_type=std_logic lab=vdd}
C {iopin.sym} -350 -90 0 0 {name=p32 lab=0b}
C {iopin.sym} -350 80 0 0 {name=p37 lab=1b}
C {iopin.sym} -350 250 0 0 {name=p41 lab=2b}
C {iopin.sym} -350 420 0 0 {name=p42 lab=3b}
