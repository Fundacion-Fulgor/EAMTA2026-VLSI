...
C {lab_pin.sym} -40 -60 2 0 {name=p9 sig_type=std_logic lab=en
}
...
C {lab_pin.sym} -40 70 0 0 {name=p12 sig_type=std_logic lab=noten
}
...
C {blocks/register/schematic/register.sym} 10 0 0 0 {name=x1}
