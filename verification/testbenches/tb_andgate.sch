...
N -70 -10 -40 -10 {lab=va}
N -70 10 -40 10 {lab=vb}
...
C {lab_pin.sym} -70 10 0 0 {name=p2 sig_type=std_logic lab=vb
}
...
C {lab_pin.sym} -70 -10 0 0 {name=p12 sig_type=std_logic lab=va
}
C {lab_pin.sym} 380 -120 0 0 {name=p13 sig_type=std_logic lab=avss1p8
}
C {blocks/andgate/schematic/andgate.sym} -40 10 0 0 {name=x1}
